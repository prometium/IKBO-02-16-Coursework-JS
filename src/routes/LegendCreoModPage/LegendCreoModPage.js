...
function LegendCreoModPage({ data }) {
 ...
 /* useEffect(() => {
    ...
    {
        return fetch('https://min-api.cryptocompare.com/data/price?fsym=BTC&tsyms=RUB,USD'+
    ...
    return (
        ...
        <>
            ...
            <div className="content">
                <p>USD: {price_USD}</p>
                <p>RUB: {price_RUB}</p>
                <button className = "button" onClick={OnClick}>Получить данные о курсе биткоина</button>
            </div>
            <div className = 'vk'>
