        ...
        <>
            <div className="content">
                ...
                <div className = 'outerDiv'>
                    <input type="text" className="input" ref={niknameRef} placeholder="Введите никнейм на GitHub"/>
                    <button className = "button" onClick={() => {setName(niknameRef.current.value);}}>Вывести репозитории пользователя</button>    
